...
to można przypisać ramkę danych do rastra.
...
**8.** Pobierz scenę satelitarną o niskim zachmurzeniu i dotnij jej zasięg do
wybranego powiatu. Następnie dokonaj klasyfikacji nadzorowanej używając
dowolnie wybranych danych referencyjnych o pokryciu terenu, np. [S2GLC](https://s2glc.cbk.waw.pl/),
[CLC](https://land.copernicus.eu/en/products/corine-land-cover) czy
[BDOT10K:Pokrycie Terenu](https://www.geoportal.gov.pl/pl/dane/baza-danych-obiektow-topograficznych-bdot10k/)
(liczba klas nie powinna być zbyt duża). Po wytrenowaniu modelu klasyfikacyjnego
oceń jego skuteczność na zbiorze testowym oraz oblicz procentowy udział
poszczególnych klas pokrycia terenu na analizowanym obszarze. Finalnie, porównaj
wyniki klasyfikacji z mapą referencyjną używając identycznego schematu kolorów.
